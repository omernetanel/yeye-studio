...
const principles = [
  ...
  { icon: Smartphone, title: "מובייל קודם", description: "רוב התנועה מגיעה מהטלפון, אז ככה גם אנחנו מתכננים, מההתחלה." },
...
const processSteps = [
  ...
  { number: "03", icon: Code2, title: "עיצוב ופיתוח", description: "בונים את הדף מאפס, לא מתבנית מוכנה. עיצוב שמתאים לקהל שלך, פיתוח מהיר עם Next.js, וחוויית מובייל מושלמת. כל פיקסל נועד לשרת את המטרה." },
...
const whatYouGetRows = [
  ...
  [
    { number: "03", title: "ליווי טכני מקצה לקצה", description: "דומיין, שרת, חיבורים, אינטגרציות: את כל הבירוקרטיה הדיגיטלית מטפלים אנחנו. לא צריך להיות מומחה כדי להשיק דף נחיתה מקצועי." },
    { number: "04", title: "תמיכה לאחר ההשקה", description: "חודש תמיכה מלאה אחרי ההשקה, ללא עלות נוספת. אנחנו כאן לכל תיקון, עדכון קטן, או שאלה שתעלה." },
  ],
];
