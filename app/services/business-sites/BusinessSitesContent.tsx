    ...
    <main className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="relative z-10">
        ...
        <WhatIsIt
          ...
          text="אתר תדמית הוא הפנים הדיגיטליות של העסק שלך. הוא לא מוכר ישירות — הוא בונה אמון, מציג מומחיות, ומוביל לקוחות פוטנציאליים לפנות אליך. זה ההבדל בין עסק שנראה אמין לבין עסק שנראה מקצועי באמת."
        />
