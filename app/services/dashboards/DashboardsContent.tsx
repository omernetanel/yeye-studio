...
const whatYouGetRows = [
  [
    ...
    { number: "02", title: "זמינות אמיתית", description: "יש שאלה או צריך פיצ'ר חדש? פשוט כותבים לנו. תמיד תדע בדיוק עם מי אתה מדבר ומי אחראי על המערכת שלך." },
  ],
  [
    { number: "03", title: "ליווי טכני מקצה לקצה", description: "שרת, דומיין, גיבויים ואבטחה, הכל מסודר מהצד שלנו. אין צורך להיות מהנדס כדי להפעיל מערכת מקצועית." },
    { number: "04", title: "תמיכה לאחר ההשקה", description: "בחודש שאחרי ההשקה אנחנו איתך צמוד: תיקונים, שיפורים, ושאלות שעולות תוך כדי עבודה." },
  ],
];
    ...
    <main className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="relative z-10">
        ...
        <WhatIsIt
          ...
          text="מערכת ניהול היא כלי עבודה פנימי שבנוי במיוחד לעסק שלך. בניגוד לתוכנות גנריות שצריך להתאים לעצמך, אנחנו בונים בדיוק מה שצריך, לא יותר ולא פחות. התוצאה היא מערכת שכולם בצוות שלך ישתמשו בה כי היא פשוטה ומדויקת."
        />
