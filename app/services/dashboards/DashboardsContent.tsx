...
const principles = [
  { icon: LayoutDashboard, title: "ממשק פשוט", description: "מערכת מורכבת לא חייבת להיות קשה לשימוש. אני בונה ממשקים שאפשר להבין תוך דקות." },
...
const processSteps = [
  { number: "01", icon: MessageSquare, title: "מיפוי תהליכים", description: "אני יושב איתך ומבין איך העסק עובד: אילו נתונים חשובים, אילו תהליכים חוזרים, ואיפה הכי הרבה זמן מתבזבז." },
  { number: "02", icon: Paintbrush, title: "עיצוב הממשק", description: "אני בונה ממשק שמותאם לאנשים שישתמשו בו: פשוט, ברור, ומהיר. לא צריך הדרכה ארוכה כדי להתחיל." },
  { number: "03", icon: Code2, title: "פיתוח ואינטגרציות", description: "אני בונה את המערכת עם כל החיבורים הנדרשים: תשלומים, יומן, מייל, ו-WhatsApp. הכל מחובר ועובד." },
  { number: "04", icon: Rocket, title: "השקה והדרכה", description: "אני מעביר את הצוות שלך על המערכת עד שכולם מרגישים בנוח. תמיכה מלאה בחודש הראשון." },
];
...
const whatYouGetRows = [
  [
    { number: "01", title: "הדרכת צוות מלאה", description: "לא מעביר לך מערכת ונעלם. מדריך את כל הצוות עד שכולם עובדים בביטחון ובמהירות." },
    { number: "02", title: "זמינות אמיתית", description: "יש שאלה או צריך פיצ'ר חדש? פשוט תכתוב לי. תמיד תדע בדיוק עם מי אתה מדבר ומי אחראי על המערכת שלך." },
  ],
  [
    { number: "03", title: "ליווי טכני מקצה לקצה", description: "שרת, דומיין, גיבויים ואבטחה, הכל מסודר מהצד שלי. אין צורך להיות מהנדס כדי להפעיל מערכת מקצועית." },
    { number: "04", title: "תמיכה לאחר ההשקה", description: "בחודש שאחרי ההשקה אני איתך צמוד: תיקונים, שיפורים, ושאלות שעולות תוך כדי עבודה." },
  ],
];
    ...
    <main className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="relative z-10">
        ...
        <WhatIsIt
          ...
          text="מערכת ניהול היא כלי עבודה פנימי שבנוי במיוחד לעסק שלך. בניגוד לתוכנות גנריות שצריך להתאים לעצמך, אני בונה בדיוק מה שצריך, לא יותר ולא פחות. התוצאה היא מערכת שכולם בצוות שלך ישתמשו בה כי היא פשוטה ומדויקת."
        />
        ...
        <ExamplesPlaceholder title="דוגמאות מהעבודה שלי" labelPrefix="מערכת ניהול" />
