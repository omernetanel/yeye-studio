...
const stats = [
  ...
  { stat: "×3", statLabel: "יותר מכירות עם UX נכון", text: "ההבדל בין חנות שממירה לחנות שלא הוא לא המוצר, זו החוויה. ניווט ברור, תמונות איכותיות, ותהליך תשלום פשוט יכולים להכפיל ולשלש את ההכנסה מאותה תנועה." },
];
