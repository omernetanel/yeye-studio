...
const baseClasses =
  ...
  "btn-shimmer inline-flex items-center gap-2 whitespace-nowrap rounded-full px-8 py-[13px] font-display text-m-body font-medium transition-transform duration-200 ease-out hover:scale-[1.04] active:scale-100 disabled:cursor-wait disabled:opacity-70 disabled:hover:scale-100";
