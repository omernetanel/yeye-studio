...
export default function HeroSection() {
  ...
  const naturalAspectRef = useRef(8042 / 2511);
  ...
  const logoBlock = prefersReducedMotion ? (
    ...
    <div className="relative mx-auto">
      ...
      <div ref={spacerRef} className="invisible absolute inset-x-0 top-0 aspect-[8042/2511] w-full" aria-hidden />

      <div ref={logoRef} className="relative mx-auto aspect-[8042/2511] w-full select-none">
        <motion.div
          initial={wipeInitial}
