...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative flex min-h-[calc(100vh-80px)] items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1400px] px-6 pt-[100px]">
        <div className="flex w-full max-w-[620px] flex-col text-right">
          ...
          <motion.p
            ...
            className="mt-8 font-display text-[17px] leading-[1.8] text-white/72"
          >
