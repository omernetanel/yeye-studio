      ...
      <div className="mx-auto flex max-w-[1200px] flex-col items-center gap-6 px-6 py-8 text-center md:grid md:h-20 md:grid-cols-3 md:items-center md:py-0 md:text-inherit">
        ...
        <div className="flex items-center gap-5">
          <Link
            ...
            aria-label="WhatsApp"
            className="flex text-black/45 transition-colors hover:text-accent"
          >
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          />
          <span className="font-display text-[10px] font-normal tracking-[0.2em] text-black/35 uppercase">
            LABS
          </span>
        </div>

        {/* Copyright */}
        <div className="font-display text-[13px] text-black/35">© 2026 YEYE LABS. כל הזכויות שמורות.</div>
      </div>
    </footer>
  );
}
